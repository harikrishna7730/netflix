        ...
        <div className="w-full h-[600px] text-white">
          <div className="w-full h-full">
            ...
            <h1 className="text-4xl font-bold ml-2">{movie?.title}</h1>
              <button className="text-xl bg-white rounded-sm cursor-pointer text-black px-4 py-2 m-3 border-black hover:bg-slate-400  hover:border-solid hover:border-black">Play</button>
