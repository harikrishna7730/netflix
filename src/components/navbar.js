  ...
  return (
    <>
      <div className="flex items-center justify-between p-4 flex-row w-full cursor-pointer absolute z-[100]">
        ...
        <div>
        <input type="search"  className="relative z-10 bg-transparent w-10 h-11 rounded-full border focus:w-full focus:border-white-100 outline-none cursor-pointer focus:cursor-text pl-12 focus:pl-16 text-white" name="search" id="search" ></input>
        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" fill="white" class="w-30 h-12 absolute inset-y-0 my-auto px-3.5 border-r border-r-transparent peer-focus:border-white  peer-focus:stroke-white">
